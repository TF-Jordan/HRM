...
function PageSettings() {
  ...
  const [section, setSection] = useS_set('company');
        ...
        <tbody>
          {[
            ...
            <tr key={i}>
              ...
              <td>
                <span className={"badge " + (u.r === 'Super admin' ? 'orange' : u.r === 'Manager' ? 'blue' : u.r === 'Paie' ? 'green' : 'violet')}>{u.r}</span>
              </td>
        ...
        <div key={i} className="card card-pad">
          <div className="row" style={{marginBottom:10}}>
            ...
            {x.status === 'connected' ?
              ...
              <span className="badge gray">Déconnecté</span>}
          </div>
