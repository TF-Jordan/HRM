...
public class OrganizationApplicationService
                ...
                .flatMap(organization -> organizationRepository.existsByCode(organization.tenantId(), organization.code())
                        .flatMap(exists -> exists
                                ...
                                : organizationRepository.save(organization)
                                        .flatMap(saved -> provisionConfiguredDefaultSubscriptions(saved)
    ...
    private Mono<Void> provisionConfiguredDefaultSubscriptions(Organization organization) {
        if (!organizationServiceSubscriptionQuotaProperties.isProvisionSubscribableServicesOnCreate()) {
            return Mono.empty();
        }
